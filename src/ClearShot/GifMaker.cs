...
internal static class GifMaker
{
    public static void Save(Recording recording, string path)
    {
        ...
        {
            // A palette per frame keeps colours right when the content changes. No dithering: screen content is
            // mostly flat UI and text, and dither noise shimmers between frames and inflates the file.
